...
public class Aggregation_Constraints extends BaseConstraintsDescriptor {
  ...
  private static boolean staticCanBeAParent(SNode node, SNode childNode, SAbstractConcept childConcept, SContainmentLink link) {
    return !(SConceptOperations.isExactly(SNodeOperations.asSConcept(childConcept), CONCEPTS.Aggregation$vi));
  }
  private static final SNodePointer canBeParentBreakingPoint = new SNodePointer("r:39af35bd-6035-49b4-8b40-6f8b9f67bec2(DataDictionaryLan.constraints)", "5366905740650669858");
