...
public final class IElement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0xc2fcd0fd4f134552L, 0x8306bb0d4f1a7057L, 0x4a7b1456067980e5L, "DataDictionaryLan.structure.IElement");
  ...
  public static final SMethod<Void> createNewFieldDef_id6ttyxz4A9$r = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("createNewFieldDef").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7448261197722851611L).languageId(0x8306bb0d4f1a7057L, 0xc2fcd0fd4f134552L).build2(SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), ""));
  public static final SMethod<Boolean> fieldNameAlreadyExist_id6ttyxz4A9A4 = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.class)).name("fieldNameAlreadyExist").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7448261197722851716L).languageId(0x8306bb0d4f1a7057L, 0xc2fcd0fd4f134552L).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
